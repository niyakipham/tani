...
export const Header = () => {
 ...
 return (
 <header className={`fixed top-0 right-0 w-[calc(100%-100px)] max-lg:w-full h-[80px] max-md:h-[70px] flex items-center justify-between px-8 lg:px-10 max-md:px-5 z-[500] transition-all duration-300 ${isScrolled ? 'bg-[#fdfaf6]/85 border-b border-[#1f1a1d]/10 backdrop-blur-xl shadow-[0_15px_30px_rgba(31,26,29,0.03)]' : 'bg-transparent'}`}>
 ...
 <div className="flex items-center gap-3.5 max-md:gap-2 bg-[#fff] border border-[#1f1a1d]/10 shadow-[0_18px_32px_rgba(31,26,29,0.06)] py-3 px-6 max-md:py-2.5 max-md:px-3 transition-all rounded-[20px] focus-within:border-[#d7b4ea] focus-within:shadow-[0_20px_35px_rgba(215,180,234,0.22)]">
